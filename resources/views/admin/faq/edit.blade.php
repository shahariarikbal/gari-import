...
@section('content')
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/faq-list') }}">Faq List</a> <span style="font-weight: bold; margin-left: 5px;">>></span></li>
        ...
        <div class="col-md-12" style="padding: 20px;">
            <div class="row">
                ...
                <div class="col-md-10" style="background-color: #e9ecef">
                    <div class="card-body">
                        <form style="margin-top: 10px;" action="{{ url('/update-faq/'.$faq->id) }}" method="post">
                            @csrf
