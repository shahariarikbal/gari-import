...
@section('content')
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" style="margin-left: 10px;">News Create</li>
        </ol>
        ...
        <div class="col-md-12" style="padding: 20px;">
            <div class="row">
                ...
                <div class="col-md-10" style="background-color: #e9ecef">
                    <div class="card-body">
                        <form style="margin-top: 10px;" action="{{ url('/store-news') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="editor">{{Request::old('description')}}</textarea>
